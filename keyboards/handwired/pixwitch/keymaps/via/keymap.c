...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0] = { ENCODER_CCW_CW(KC_LBRC, KC_RBRC), ENCODER_CCW_CW(S(KC_LBRC), S(KC_RBRC)), ENCODER_CCW_CW(KC_G, KC_Y), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [1] = { ENCODER_CCW_CW(KC_LBRC, KC_RBRC), ENCODER_CCW_CW(S(KC_LBRC), S(KC_RBRC)), ENCODER_CCW_CW(KC_G, KC_Y), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) }
};
#endif
